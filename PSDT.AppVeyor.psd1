@{
    ...
    FunctionsToExport = @("Get-AVProject","Get-AVBuild","Get-AVRestHeader","Test-AVBuildToday","Update-AVBuild","Update-AVBuildRevision","Update-AVBuildVersion","Invoke-AVScriptAnalysis","Invoke-PSDTPostBuild","Invoke-PSDTPreBuild")
}